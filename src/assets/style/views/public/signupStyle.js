...
export const TexSubtHeadline = styled.h5`
  box-sizing: border-box;
  display: flex;
  flex-direction: row;
  width: auto;
...
export const SignInMethode = styled.div`
  box-sizing: border-box;
  display: flex;
  flex-direction: row;
  width: 100%;
...
export const TermConditions = styled.div`
  box-sizing: border-box;
  display: flex;
  flex-direction: row;
  width: 100%;
...
export const LinkTermCondition = styled(Link)`
  font-size: 0.85rem !important;
